...
<body>
	...
	<form action="" method="GET">
		<fieldset class="form-group textEdit vis">
		...
		<fieldset class="form-group textEdit">
			<label for="exampleInputISBN">isbn</label style="display: none">
		...
		<fieldset class="form-group textEdit vis">
			<img class="bookdisplay" src= "<?php if (isset($img)) { echo $img; } ?>"></img>
		...
		<center><input type="submit" id="search" name="search" value = "search" class="btn btn-primary fancyButton"></input>
				<input type="submit" id="submit" name="submit" value = "submit" class="btn btn-primary fancyButton"></input>
		</center>
	</form>
</body>
</html>